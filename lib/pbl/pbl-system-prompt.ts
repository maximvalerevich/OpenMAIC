...
2. Переключитесь на **agent**: Определите 2-4 роли для студентов (НЕ создавайте управленческие роли)
...
- Роли должны дополнять друг друга (напр., «Аналитик данных», «Фронтенд-разработчик»)
...
- Задачи должны быть взаимосвязаны (предыдущие создают основу для следующих)
- Каждая задача требует: заголовок, описание, ответственный (имя роли) и участники
