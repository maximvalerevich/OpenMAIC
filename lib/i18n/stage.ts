...
export const stageRuRU = {
  stage: {
    ...
    confirmSwitchMessage:
      'В данный момент идёт обсуждение. Переключение сцены завершит текущую тему. Продолжить?',
  ...
  pbl: {
    ...
    chat: {
      ...
      send: 'Отправить',
      welcomeMessage:
        'Привет! Я ваш помощник по задаче: "{title}"\n\nЧтобы помочь вам, я подготовил несколько вопросов:\n\n{questions}\n\nОбращайтесь через @question, если нужна помощь!',
